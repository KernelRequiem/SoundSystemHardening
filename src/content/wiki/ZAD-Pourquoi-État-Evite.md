...
**Mécanique :**
Une ZAD occupée depuis 2+ ans a un terrain cartographié par les occupants. Chemins connus, obstacles plantés, points de retraite identifiés.
...
**Implication pour l'État :**
Entrée par pont = étranglement de colonne (facile d'être arrêté). Contournement = traversée de terrain inconnu (hélicoptère + harnais = débordement possible).
...
**Mécanique :**
ZAD = défense de l'environnement. Les médias comprennent : "Les flics attaquent les écologistes."
...
**Calcul préfectoral :**
Intervenir = risque d'être peint comme "despotique". Ne pas intervenir = attendre, négocier, garder image positive.
...
**Mécanique :**
L'État a besoin de justifier légalement une intervention massive. Juste "occupation" = faible. Il faut "trafic de drogue" ou "menace à la sécurité".
...
**Mécanique :**
L'État n'intervient que s'il y a pression politique ou médiatique. ZAD silencieuse = pas d'urgence.
...
**Mécanique :**
Si État est en dialogue, il y a coût à briser le dialogue par force.
...
**Implication :**
État ne veut pas paraître "autoritaire" si dialogue est visible.
...
**Mécanique :**
État a budget limité. 400 agents * 2 jours = coût énorme. Si autre urgence surgit, intervention reportée.
...
Préfet pense : "Coûter 250k pour évacuer 100 personnes ? Ou laisser traîner ?"
