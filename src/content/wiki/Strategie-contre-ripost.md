...
1. Forces de l'ordre te verbalisent pour participation à free party
2. Te propose AFD de 1 500€ sur le terrain
3. **Si tu paies dans les 15 jours** : amende minorée, fin de la procédure
4. **Si tu refuses de payer dans les 45 jours** : majorations possibles, puis poursuites
5. **Si tu contestes** : renvoi au tribunal (risque sanction plus élevée)

### Ce que dit la Défenseure des droits

[En mai 2023, la Défenseure des droits a publié une décision critiquant sévèrement l'AFD](https://www.defenseurdesdroits.fr/la-defenseure-des-droits-recommande-de-mettre-fin-la-procedure-de-lamende-forfaitaire-delictuelle). Elle constate des "atteintes majeures aux droits et à l'égalité" :
...
[La Défenseure a recommandé d'abolir complètement l'AFD et de revenir à une procédure judiciaire pour tous les délits](https://www.vie-publique.fr/en-bref/289613-amende-forfaitaire-delictuelle-que-dit-la-defenseure-des-droits).
...
[Selon la Défenseure des droits, si plusieurs infractions sont constatées simultanément, l'AFD n'est pas censée s'appliquer. Si tu refuses la destruction de la drogue saisie par exemple, les forces de l'ordre sont obligées d'ouvrir une enquête, ce qui empêche l'AFD](https://mars-infos.org/resister-collectivement-a-l-amende-8622).
...
[Les forces de l'ordre commettent souvent des erreurs en notant les adresses. Il arrive que l'avis d'AFD n'arrive pas, soit majoré, soit jamais notifié correctement](https://mars-infos.org/resister-collectivement-a-l-amende-8622).
...
### Stratégie 4 : Contester auprès du Procureur (dans les 45 jours)

#### Si tu reçois l'avis d'AFD

Tu as **45 jours** pour former une requête en exonération (art. 495-19 et suivants du Code de procédure pénale). Cela relance une procédure judiciaire normale.

#### Les risques

[Important : si tu contestes, le Procureur peut décider de poursuivre au tribunal correctionnel. Tu risques alors une sanction **supérieure** à 1 500€](https://captain-radar.com/blog/actualite/amende-forfaitaire-delictuelle/), jusqu'à 7 500€ ou 6 mois prison.
...
[Selon le droit en vigueur, l'AFD **est illégale** si](https://mars-infos.org/resister-collectivement-a-l-amende-8622) :
...
**Pour les free parties :** Si on te reproche "participation" + "consommation de stupéfiants" + autre infraction, l'AFD peut être invalidée.
...
- **FSJS** (Fonds de Soutien Juridique des Sons) : https://drive.google.com/file/d/1LQp8x98UdDRAgh6cpCDCNhb2Py1EaKpl/
- **Pétition AN** : https://petitions.assemblee-nationale.fr/initiatives/i-5428

### Documentation

- [Défenseure des droits : décision sur AFD (2023)](https://juridique.defenseurdesdroits.fr/doc_num.php?explnum_id=21662)
- [Marseille Infos Autonomes : Résister à l'AFD](https://mars-infos.org/resister-collectivement-a-l-amende-8622)
- [CNCDH : Généralisation AFD = recul droits](https://www.cncdh.fr/actualite/generalisation-de-lamende-forfaitaire-delictuelle-un-recul-des-droits-pour-les)
...
|---|---|---|---|
| Refuser de payer AFD immédiatement | Droit de contester dans 45j | Majoration possible | Paralyse l'État |
...
**Principes :**
1. **Ne pas accepter immédiatement** = droit de contester
2. **Ne pas signer** = espace de réflexion
3. **Collectif** = pouvoir de négociation
4. **Documentation** = preuve contre États
