...
1. [Comprendre une contravention](#1-comprendre-une-contravention)
2. [Deux choix : payer ou contester](#2-deux-choix--payer-ou-contester)
3. [Procédure de contestation en ligne](#3-procédure-de-contestation-en-ligne)
4. [Réponse de l'Officier du Ministère Public (OMP)](#4-réponse-de-lofficier-du-ministère-public-omp)
5. [Requête en exonération (second tour)](#5-requête-en-exonération-second-tour)
6. [Comparution au tribunal de police](#6-comparution-au-tribunal-de-police)
7. [Les infractions concernées et comment les contester](#7-les-infractions-concernées-et-comment-les-contester)
8. [Constituer ses preuves](#8-constituer-ses-preuves)
9. [Situations spécifiques](#9-situations-spécifiques)
10. [Délais récapitulatifs](#10-délais-récapitulatifs)
11. [FAQ complète](#11-faq-complète)
12. [Ressources et contacts](#12-ressources-et-contacts)
...
| 3e | 68 € | 450 € |
| 4e | 135 € | 750 € |
| 5e | 200 € (ou 1 500 €) | 1 500 € (ou 3 000 € récidive) |

Les infractions liées aux free parties relèvent principalement de la 4e et 5e classe.
...
* **Date de l'avis** : peut être différente de la date des faits. Les délais de contestation courent à partir de cette date.
...
* **Référence réglementaire** : l'arrêté préfectoral ou l'article de loi invoqué.
* **Montant minoré / forfaitaire / majoré**.

> Scanne ou prends en photo ta contravention dès réception. Les délais sont courts et la perte du document complique tout.
...
| Après 45 jours sans action | Amende majorée | Automatique |
...
### Étape 2 : rédiger la contestation

Le champ texte est limité en taille. Utiliser un traitement de texte pour rédiger une lettre PDF, puis la joindre en pièce jointe.
...
* Preuves matérielles (captures d'écran, articles de presse, relevés GPS…)
* Toute pièce utile à ta défense

### Étape 4 : sauvegarder l'accusé de réception
...
Même valeur juridique que la contestation en ligne. Envoyer en recommandé avec accusé de réception à l'adresse indiquée sur l'avis de contravention.

---

## 4. Réponse de l'Officier du Ministère Public (OMP)

L'OMP a trois options après réception de ta contestation :
...
> Dans la procédure FSJS, le scénario classique est : contestation initiale sans témoins → rejet OMP → second tour avec attestations de témoins.

---

## 5. Requête en exonération (second tour)

Après réception du rejet OMP, tu peux maintenir ta contestation en adressant un dossier complet au tribunal de police.

### Composition du dossier

* Lettre de présentation avec tes filiations (nom, prénom, date de naissance, adresse)
* Copie du rejet de requête en exonération (optionnel mais conseillé)
* La requête en exonération elle-même (reprend et renforce tes arguments)
* Copie de ta pièce d'identité ou permis de conduire
* Attestations de témoins si tu n'en avais pas joint à la première étape
...
L'OMP, après réception de ce second dossier, peut :
...
* **Condamnation à un montant supérieur** : jusqu'au maximum légal de la classe de contravention. Pour une contravention de 4e classe (135 € forfaitaire), le juge peut monter jusqu'à 750 €.

### Préparer l'audience

* Venir avec toutes les pièces originales (attestations, preuves matérielles).
...
### Aide ou assistance à tapage nocturne
...
* Tu ne pouvais pas agir sur la production de musique (tu n'étais pas aux commandes, tu n'avais aucun accès au matériel de sonorisation).
...
**Libellé légal :** arrêt ou stationnement dangereux du véhicule.
...
**Ce que dit la loi :** cet article vise les manifestations revendicatives urbaines. Elles sont soumises à autorisation de la mairie et peuvent être interdites.
...
* L'infraction d'organisation d'un rassemblement festif non déclaré (art. R211-27 CSI) ne s'applique qu'aux organisateurs (Cass. Crim., 17 mars 2020, n° 19-82.117). En tant que simple participant, tu ne relèves pas de cette infraction.

**Attention :** cette infraction est parfois utilisée de manière approximative par les forces de l'ordre. Vérifier que le libellé correspond bien à l'article invoqué.
...
**Ce que tu dois faire en premier :** identifier l'arrêté préfectoral cité sur la contravention. Il doit apparaître une référence d'arrêté. Cherche-le sur le site de la préfecture du département.

**Arguments de contestation :**

* **Argument clé :** l'arrêté préfectoral interdit les "rassemblements festifs à caractère musical" (c'est-à-dire des événements), pas les "rassemblements de personnes" (c'est-à-dire des regroupements de personnes physiques). Ce sont deux notions juridiques distinctes. Ta simple présence physique ne constitue pas une infraction sur la base d'un arrêté qui interdit un type d'événement.
* L'arrêté n'était pas porté à la connaissance du public de manière suffisante au moment des faits (pas de publication, pas d'affichage).
* L'arrêté est illégal : pas motivé, disproportionné, champ trop large (voir `recours-juridiques.md` pour contester l'arrêté lui-même).
* Tu ne te trouvais pas dans le périmètre géographique couvert par l'arrêté.
* Tu n'étais pas présent à l'heure de l'infraction alléguée.

**Preuves utiles :**
* Texte exact de l'arrêté préfectoral (téléchargé sur le site de la préfecture).
* Démonstration que l'arrêté interdit un "rassemblement" au sens événementiel, non la présence de personnes.
...
**Libellé légal :** organisation d'un rassemblement exclusivement festif à caractère musical sans déclaration préalable (art. R211-27 CSI). Contravention de 5e classe.

**Important :** seuls les organisateurs sont visés par cette infraction (Cass. Crim., 17 mars 2020, n° 19-82.117). Les participants ne peuvent pas être condamnés sur ce fondement.

**Arguments de contestation si tu es poursuivi comme "organisateur" alors que tu ne l'étais pas :**

* Tu n'avais aucun rôle décisionnel (lieu, date, matériel, financement).
* Tu n'avais pas accès au matériel de sonorisation.
...
**Libellé légal :** certains arrêtés préfectoraux interdisent également "la circulation des véhicules transportant du matériel de son destiné à des rassemblements festifs non déclarés."
...
* L'arrêté préfectoral est illégal ou disproportionné.
* Tu ne te trouvais pas dans le périmètre couvert par l'arrêté.

**Preuves utiles :**
* Documents prouvant la destination légale du matériel.
* Factures, contrats de location ou de prêt du matériel.
...
| Refus d'obtempérer | Art. L233-1 Code route | Délit si force ou manœuvre. |
...
**Règles pour que l'attestation soit recevable :**
...
* Le texte doit être objectif : constatations factuelles uniquement, pas de jugements.
...
* Que tu ne participais pas à la production de musique.
* Que tu n'avais aucun rôle organisationnel.
* Que tu te trouvais à un autre endroit.

**Qui peut témoigner :**

* Toute personne majeure, sauf conjoint en instance de divorce ou partie à l'affaire. Mettre "ami" ou "connaissance" dans la case "lien" si tu ne la connais pas très bien.
...
* Si l'OMP classe sans suite dès le premier tour, tu as gagné sans exposer tes témoins.
* Si l'OMP rejette, tu envoies les attestations au second tour avec un dossier renforcé.

Ce n'est pas une obligation : joindre les attestations dès le premier tour accélère parfois la résolution et réduit le risque de convocation au tribunal.
...
**Exception à vérifier :** si l'agent t'a demandé "reconnaissez-vous les faits ?" et que tu as signé après cette question, il est conseillé de ne pas mentionner cet épisode dans la contestation. Ne pas non plus mentir sur ce point.
...
* En cas de relaxe ou de non-condamnation à la confiscation, le matériel doit être restitué.
...
### Plusieurs personnes ont reçu la même amende

Il n'existe pas de recours collectif pour les contraventions. Chaque contravention est nominative et doit être contestée individuellement. Vous pouvez cependant coordonner vos arguments et vous citer mutuellement comme témoins.
...
Date de l'avis de contravention
        │
        ├─ J+15 (J+30 télépaiement) ──── Tarif minoré si paiement
        │
        ├─ J+45 (J+60 télépaiement) ──── Limite paiement tarif forfaitaire
        │                                 Limite pour contester sans majoration
        │
        └─ Après J+45 sans action ─────── Amende majorée automatique

Après contestation initiale
        │
        ├─ Réponse OMP ─────── Variable (quelques semaines à 2-3 mois)
        │
        └─ En cas de rejet : second dossier à envoyer en recommandé
                                 (pas de délai strict mais agir vite)

Après convocation au tribunal
        │
        └─ Audience ──────── Date indiquée sur la convocation
...
En général non. La signature vaut réception de l'avis. Cela n'empêche pas de contester ultérieurement. Si l'agent te demande si tu reconnais les faits et que tu signes après cette question, la situation est plus ambiguë. Conseil : refuser systématiquement de signer sans savoir exactement ce qu'on signe.
...
**Avec les délais de contestation, l'amende va être majorée ?**
...
Vérifier scrupuleusement chaque champ : numéro d'avis exact (pas de faute de frappe), date exacte au format demandé, numéro d'immatriculation exact si demandé. Si le problème persiste après plusieurs tentatives, contacter l'ANTAI ou passer par la contestation par courrier.

**Que se passe-t-il si je ne vais pas à l'audience du tribunal ?**
...
Les contraventions se prescrivent en 1 an à compter des faits. Si l'avis de contravention est reçu plus d'un an après les faits, c'est un moyen de défense.
...
* **Art. L211-5 CSI :** définition du rassemblement festif à caractère musical
