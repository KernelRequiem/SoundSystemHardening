...
Actuellement, l'organisation d'un rassemblement festif non déclaré ou en violation d'un arrêté préfectoral relève d'une contravention de 5e classe selon l'[article R211-27 du Code de la sécurité intérieure](https://questions.assemblee-nationale.fr/q16/16-3582QE.htm). La contravention de 5e classe entraîne une amende de 1 500 euros (3 000 euros en cas de récidive).
...
Pour la majorité des infractions, [le point de départ de la prescription est le jour où l'infraction est commise](https://www.service-public.gouv.fr/particuliers/vosdroits/F36493/0). Pour une free party organisée le 15 juin 2024, le délai de prescription court à partir de cette date.
...
Selon l'[article L211-15 du CSI](https://questions.assemblee-nationale.fr/q16/16-3582QE.htm), le matériel saisi peut être retenu pendant une durée maximale de **6 mois en vue de sa confiscation par le tribunal**.
...
Techniquement, avec des actes d'enquête espacés, l'État peut maintenir indéfiniment la prescription en cours. Mais cela exige une volonté de poursuivre et des ressources administratives. Pour les cas qui ne sont pas prioritaires, ce mécanisme n'est pas activé.
...
Voir aussi :
- `wiki/modus-operandi/failles-legales/seuil-250-500-personnes.md` : le seuil qui déclenche l'obligation
- `wiki/modus-operandi/failles-legales/definition-ambigue-organisateur.md` : identifier l'organisateur prend du temps
- `droits-libertes/arsenal-legislatif.md` : PPL 1133, délai 6 ans vs 1 an
- `droits-libertes/recours-juridiques.md` : les défenses procédurales basées sur la prescription
- `mobilisation/contacts-allies.md` : Me Marianne Rostan (Barreau de Paris), avocat spécialisée

**Sources :**
- [LDH : Contre le renforcement de la pénalisation, contravention 5e classe](https://www.ldh-france.org/contre-le-renforcement-de-la-penalisation-de-lorganisation-de-rave-parties/)
- [Assemblée nationale, Question n°3582 : Article R211-27, sanctions actuelles](https://questions.assemblee-nationale.fr/q16/16-3582QE.htm)
- [Service-Public : Délais de prescription des infractions pénales](https://www.service-public.gouv.fr/particuliers/vosdroits/F36493/0)
- [Service-Public : Distinction contravention / délit / crime](https://www.service-public.gouv.fr/particuliers/vosdroits/F1157)
- [Ministère de la Justice : Infractions pénales, catégories et délais](https://www.justice.gouv.fr/justice-france/justice-penale/infractions-penales)
- [LegiPermis : Délai de prescription contravention 1 an](https://www.legipermis.com/blog/2023/03/03/amende-annule-prescription/)
- [LegiPermis : Classes de contraventions, prescription 1 an](https://www.legipermis.com/infractions/contravention.html)
- [Kohen Avocats : Teknival et rave party illégale, sanctions actuelles](https://kohenavocats.com/rave-party-illegale-amende-saisie-materiel-garde-vue/)
