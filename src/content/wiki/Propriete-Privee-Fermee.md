...
**Option 2 : Demande du propriétaire pour expulsion civile**
...
**Option 3 : Constatation de crime (trafic, vol, violence)**
...
**Résultat administratif :** L'État attend que propriétaire agisse légalement. Et le propriétaire ?
...
**Comportement de l'État observé :**
Abstention. Il attend que propriétaire se plaigne. Tant qu'il ne se plaint pas, État reste passif.
...
1. Rémunération discrète (payé pour tolérer)
2. Sympathie pour le mouvement
3. Absent le weekend
4. Indifférent (champs isolés, peu d'impact)

Résultat : État découvre seulement lundi via presse. Teknival fini lundi 20h. État ne peut plus intervenir (plus personne).
...
"Monsieur le propriétaire, on peut utiliser vos champs samedi ?"
"Pourquoi pas, j'aime la musique électronique."
...
**Observation :** Accordé verbal = zone grise totale. Propriétaire peut nier après ou confirmer avant l'État. État hésite.
...
**Principe légal :**
Le propriétaire a le droit d'occuper/utiliser sa propriété. Mais le propriétaire n'est pas policier.
...
**En pratique :**
Une free party sur propriété privée = propriétaire n'aime pas = propriétaire appelle. Mais appel ≠ intervention immédiate.
...
**Cas réel observé (non-documenté publiquement mais rapporté par occupants) :**
Plusieurs free parties sur propriété privée = propriétaire tolère = État observe = n'intervient pas.
...
Abstention. Attente. Observation.

**Durée avant intervention :**
Jamais si propriétaire continue tolérer.
...
**Comportement de l'État :**
"C'est un conflit civil. Allez à la justice."

**Durée avant intervention :**
Jamais pendant l'événement. Après ? Procédure civile = 3-6 mois.
...
**Comportement de l'État :**
Peut intervenir basé sur "demande du propriétaire" + "trouble à l'ordre public".

**Durée avant intervention :**
Si plainte formelle avant l'événement = État peut justifier intervention.
...
**Accord verbal :**
"Tu peux utiliser mes champs samedi ?"
"Oui."
...
**Accord écrit :**
SMS : "Vous pouvez organiser samedi"
...
**Accord implicite :**
Propriétaire laisse la barrière ouverte, ne dit rien, accepte tacitement.
...
**Implication :**
L'ambiguïté contractuelle est une arme. Moins il y a de clarté, plus l'État hésite.
...
**Cas documenté (urbain, mais même logique) :**
Squats parisiens dans immeubles en succession = État n'intervient pas. Pourquoi ? Propriétaire incertain = Base légale faible.

**Pour free party rurale :**
Si propriétaire du terrain = en litige familial / succession = ambiguïté maximum = État abstient.
...
**Implication :**
Occuper propriété semi-publique = même ambiguïté que propriété privée avec propriétaire absent.

**Cas documenté :** Gares désaffectées en France. Propriétaire = SNCF. SNCF doit :
1. Déposer plainte
2. Obtenir ordonnance
3. Demander expulsion
4. Attendre exécution

Délai = 2-3 mois minimum. Événement = 2 jours.
...
**Vendredi 18h :**
Propriétaire agricole = pas au courant. Reçoit appel ami : "Y'a du son chez vous."

**Vendredi 19h :**
Propriétaire vient regarder. Dit "Ok, juste 48h, dimanche soir vous partez."

**Samedi 10h :**
Gendarmes locaux découvrent via dénonciation voisin. Arrivent sur place.
...
**Samedi 10h30 :**
M. Dupont confirme : "Oui ils peuvent rester, mais doivent partir dimanche 22h."

Gendarmes : "Alors vous confirmez que vous avez accepté ?"
M. Dupont : "Oui."
...
**Dimanche 22h :**
Occupants partent. Propriétaire = content d'avoir accepté (pas de casse, rien).

**Lundi :**
Gendarmes notent rapport : "Événement avec propriétaire acceptant. Pas d'infractions. Clôturé."
...
**Effet :** Si État intervient, tu montres l'accord = État a pas de base légale.
...
**SMS :**
"Bonjour M. Dupont, on aimerait faire un petit événement samedi soir chez vous. Ok ?"
"Pas de problème, allez-y."

**Email :**
Même message, sauvegarde la réponse.

**Contrat simple (rare mais possible) :**
"Je soussigné X accepte que collectif Y utilise mon terrain samedi 18h-22h moyennant [montant] euros."
...
**Scénario :**
Propriétaire agricole = ami du collectif. Propriétaire dit "Je tolère." Événement se déroule. État intervient. Propriétaire confirme "J'avais accepté." État recule.
...
**Scénario :**
Tu utilises terrain. Propriétaire = volontairement absent (sur rendez-vous ailleurs). Ne peut pas être contacté État. Événement se déroule. Propriétaire revient lundi = "Je savais pas."
...
Si État arrive pendant événement et parle au propriétaire sous pression :
"Monsieur, vous confirmez avoir accepté ?"
Propriétaire peut dire "Non, je suis forcé de dire oui."
...
1. Ambiguïté qui : État hésite à intervenir propriété d'autrui
2. Absence propriétaire : Propriétaire absent = État impuissant
3. Toleration propriétaire : Accord = État pas de base légale
4. Lenteur procédure civile : Propriétaire hostile doit aller justice (2-3 mois)

**Faille majeure :** Une fois État décide "c'est un trouble à l'ordre public", propriété privée ne protège plus = intervention possible.
