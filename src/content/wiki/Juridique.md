...
Cette page détaille le premier axe de la stratégie de résistance : utiliser le droit comme outil offensif. Elle couvre les textes applicables, les procédures de recours devant les tribunaux administratifs, la construction de dossiers de violences policières, et les limites réelles de chaque levier.

---

## Sommaire

1. [Comprendre le cadre légal avant d'agir](#comprendre-le-cadre-légal-avant-dagir)
2. [Contester un arrêté préfectoral](#contester-un-arrêté-préfectoral)
   - [Le recours gracieux](#le-recours-gracieux)
   - [Le référé-suspension (L521-1 CJA)](#le-référé-suspension-l521-1-cja)
   - [Le référé-liberté (L521-2 CJA)](#le-référé-liberté-l521-2-cja)
   - [Le recours en annulation au fond](#le-recours-en-annulation-au-fond)
3. [Jurisprudence : ce qui s'est passé devant les tribunaux](#jurisprudence--ce-qui-sest-passé-devant-les-tribunaux)
4. [Documenter les refus préfectoraux](#documenter-les-refus-préfectoraux)
...
| Type d'acte | Auteur | Recours adapté |
|-------------|--------|----------------|
| Arrêté préfectoral d'interdiction | Préfet | Référé-suspension, référé-liberté, recours au fond |
| Refus de déclaration préalable | Préfet | Recours gracieux, référé-liberté |
| Saisie de matériel | Forces de l'ordre (sur arrêté ou flagrance) | Recours judiciaire, contestation devant le JLD |
...
## Contester un arrêté préfectoral

### Le recours gracieux

**Ce que c'est.** Une lettre adressée au préfet lui demandant de retirer ou modifier son arrêté, avant tout recours contentieux.

**Quand l'utiliser.** Dès la notification ou la publication de l'arrêté. Il interrompt le délai de recours contentieux (2 mois), qui repart à zéro à compter de la réponse (ou du silence de 2 mois valant rejet implicite).

**Ce que ça sert réellement.** Le recours gracieux est rarement accordé. Son intérêt principal est procédural : il force le préfet à motiver explicitement son refus, ce qui constitue des éléments utilisables dans le recours contentieux ultérieur. Il crée aussi une trace écrite de la tentative de dialogue.

**Format minimal :**

```
Objet : Recours gracieux contre l'arrêté préfectoral n° [X] du [date]

Monsieur le Préfet,

Par arrêté du [date], vous avez interdit [objet précis].

Cet arrêté porte atteinte à [libertés concernées] pour les motifs suivants :
[argumentation : disproportion, absence de base légale, etc.]

Je vous demande en conséquence de bien vouloir retirer ledit arrêté.

À défaut de réponse dans un délai de deux mois, votre silence vaudra rejet implicite.
...
* Un recours au fond en annulation de l'arrêté doit avoir été déposé préalablement ou simultanément
* Le requérant doit démontrer : (a) un doute sérieux sur la légalité de l'arrêté, et (b) une urgence justifiant la suspension [2]
...
**Argument de disproportion.** Les arrêtés annuels à l'échelle d'un département entier (Hérault 2025, Haute-Marne 2025) [3] sont particulièrement vulnérables à l'argument de disproportion : l'article L521-1 permet de soulever le défaut de mesure individuelle, l'absence d'examen au cas par cas, et le caractère excessivement général d'une interdiction couvrant 365 jours et l'intégralité d'un territoire.
...
**Délai de décision.** 48 heures [4]. C'est l'outil adapté à l'urgence absolue : teuf interdite la veille, arrêté pris à la dernière minute.

**Conditions.** Le requérant doit démontrer :
* Une urgence (condition appréciée dès la saisine, ne peut pas être rattrapée a posteriori) [5]
* Une atteinte grave et manifestement illégale à une liberté fondamentale exercée par une personne publique
...
**Représentation.** Avocat non obligatoire, mais fortement recommandé. La requête doit obligatoirement mentionner l'article L521-2 en première page [6].

**Procédure pratique :**

```
1. Rédiger la requête (mention "référé" + article L521-2 + coordonnées
   + objet + arguments d'urgence et d'atteinte grave)

2. Déposer au greffe du tribunal administratif territorialement compétent
   (le tribunal du département où l'arrêté a été pris)
   → L'enveloppe doit porter la mention "RÉFÉRÉ"

3. Le juge des référés se prononce dans les 48 heures

4. En cas de rejet : possibilité d'appel devant le Conseil d'État
   (délai très court, prévoir un avocat au Conseil d'État)
```

**Attention.** Il n'est pas possible de présenter simultanément un référé-liberté et un référé-suspension dans la même requête [6].

---

### Le recours en annulation au fond

**Ce que c'est.** Un recours pour excès de pouvoir (REP) demandant l'annulation définitive de l'arrêté, sans urgence immédiate.

**Délai.** 2 mois à compter de la notification ou publication de l'arrêté (interrompu par un recours gracieux préalable).
...
* Violation de la loi (dépassement des pouvoirs conférés par la loi de 2001)
* Détournement de pouvoir
* Disproportion au regard des libertés fondamentales

---

## Jurisprudence : ce qui s'est passé devant les tribunaux

### Arrêté Hérault 2025 : échec du référé, appel annoncé

Le 3 janvier 2025, le préfet de l'Hérault François-Xavier Lauch a édicté un arrêté interdisant sur l'ensemble du département et jusqu'au 31 décembre 2025 tous les rassemblements festifs à caractère musical non déclarés et non autorisés, ainsi que la circulation de véhicules transportant du matériel de type sound system destiné à de tels rassemblements [7].
...
La documentation systématique des refus préfectoraux de déclaration est la base de tout argument juridique sur l'impossibilité structurelle d'organiser légalement. Chaque refus doit être archivé selon ce format :

```markdown
## Refus préfectoral — [Département] — [Date]

**Préfecture :** [nom]
**Date du dépôt de déclaration :** [date]
...
**Recours engagé :** [oui/non — si oui, lequel, résultat]
**Source / pièce justificative :** [référence interne]
```
...
## Constituer un dossier de violences policières

### Les étapes du dossier

Le guide pratique de la LDH [12] identifie les étapes suivantes, à engager rapidement après l'incident :

**Immédiatement après les faits :**
* Consulter un médecin et obtenir un certificat médical initial (CMI) précisant les lésions, leur nature, et le nombre de jours d'ITT (incapacité totale de travail). Ce document est la pièce centrale du dossier
* Photographier les blessures visibles immédiatement
* Noter l'heure, le lieu précis, les conditions (description des forces de l'ordre présentes, numéros RIO des agents si visibles, véhicules)
...
2. **Plainte directe auprès du procureur de la République.** Par courrier recommandé avec AR au parquet du tribunal judiciaire du lieu des faits. C'est la voie la plus fiable pour forcer l'ouverture d'une enquête.

3. **Saisine de l'IGPN (Police nationale) ou de l'IGGN (Gendarmerie nationale).**
   * IGPN : délégations à Lille, Metz, Paris, Rennes, Lyon, Bordeaux, Marseille, Fort-de-France et bureau à Nice [12]
   * Appeler directement le service, demander une adresse électronique, et prévenir qu'on souhaite déposer une plainte formelle (pas un "signalement")
   * Les plateformes en ligne de l'IGPN/IGGN ne permettent que des signalements, pas des dépôts de plainte au sens pénal [15]
...
* L'IGPN et l'IGGN ne traitent qu'une fraction des enquêtes sur violences policières. Pour les affaires de violences par personnes dépositaires de l'autorité publique, l'IGGN indique dans son rapport 2024 avoir traité seulement 8,4% des affaires judiciaires de "police des gendarmes"
* Les plateformes en ligne ne constituent pas des dépôts de plainte effectifs et ne font pas systématiquement l'objet d'une transmission aux parquets
* Des témoignages documentent des tentatives de culpabilisation et d'intimidation des victimes lors des démarches [14]

**La plainte directe au procureur reste la voie la plus efficace**, complétée si possible par une saisine parallèle du Défenseur des droits [13].

**Saisine du Défenseur des droits :** en ligne sur defenseurdesdroits.fr, sans avocat, sans frais. Compétent pour les manquements aux règles de déontologie des forces de l'ordre. N'a pas de pouvoir de condamnation mais peut formuler des recommandations et intervenir dans des procédures judiciaires.
...
* Réseau ANAMIL (avocats spécialisés en droit des étrangers et libertés publiques)
...
Le projet de loi RIPOST, voté au Sénat le 26 mai 2026 [18], élève l'organisation d'une free party au rang de délit (2 ans de prison et 30 000 € d'amende pour les organisateurs). Cette élévation a une conséquence pratique majeure : les affaires seront dorénavant traitées par le tribunal correctionnel (et non par le tribunal de police pour les contraventions), avec des délais et des procédures plus lourds, mais aussi un droit à la défense plus structuré et des possibilités d'appel élargies.
