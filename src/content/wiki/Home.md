...
Le mouvement de la fête libre est aujourd'hui confronté à une asymétrie de moyens sans précédent. Face à une surveillance technologique de masse et à un arsenal juridique qui se durcit de mois en mois, l'ignorance est notre plus grande faiblesse.

**Cet espace a trois objectifs :**

1. **Outiller :** Fournir des méthodes concrètes pour se protéger des saisies, des infiltrations numériques et de l'intimidation policière.
2. **Documenter :** Maintenir une archive factuelle et sourcée des pratiques répressives pour mieux les anticiper et les contester.
3. **Structurer :** Harmoniser les pratiques de résistance pour que chaque collectif puisse bénéficier de l'expérience et des erreurs des autres.

## Comment naviguer dans cet espace ?
...
## ⚠️ Note sur la sécurité des données

**Ce Wiki contient des informations sensibles.**

Si tu contribues à ces pages, garde à l'esprit que cet espace est collaboratif.

* **Ne publie jamais de données nominatives** (noms de famille, plaques d'immatriculation, localisations précises en temps réel).
* **Anonymise systématiquement** les témoignages d'incidents.
* **Privilégie les faits sourcés.** La rumeur est l'ennemie de notre crédibilité.
